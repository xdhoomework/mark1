                ...
                clutter += `<div id="postsbox">
                    <div id="postsbox-1strow">
                        <div id="post-like-absolute"><img src="${randomPostUrl1}" alt="">
                            <div class="post-like-absolute"><button><i class="fa-solid fa-heart"></i></button> 14 <button><i class="fa-solid fa-comment"></i></button> 15</div>
                        </div>
                        <div id="post-like-absolute"><img src="${randomPostUrl2}" alt="">
                            <div class="post-like-absolute">
                                <button><i class="fa-solid fa-heart"></i></button>
                                <span id="likesCount">14</span>
                                <button><i class="fa-solid fa-comment"></i></button>
                                <span id="commentsCount">15</span>
                            </div>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelector("#postwithreelrow5").innerHTML = clutter;
    document.querySelector("#postwithreelrowrev5").innerHTML = clutter;
});
document.addEventListener('DOMContentLoaded', function() {
